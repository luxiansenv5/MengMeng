 ...
 */
public class PetringFriendFragement extends BaseFragment implements RefreshListView.OnRefreshUploadChangeListener{
...
//        });
    ...
    //获取网络数据
    public void getData() {
        RequestParams requestParams = new RequestParams(NetUtil.url + "QueryFriendDyanmicByUserIdServlet");
